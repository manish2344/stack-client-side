...
export const ansNewestAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://stack-overflow-063y.onrender.com/api/question/your/ans/newest/${userId}`,
      Auth
    );
...
export const ansOldestAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://stack-overflow-063y.onrender.com/api/question/your/ans/oldest/${userId}`,
      Auth
    );
...
export const quesOldestAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://stack-overflow-063y.onrender.com/api/question/your/ques/oldest/${userId}`,
      Auth
    );
...
export const quesNewestAction = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://stack-overflow-063y.onrender.com/api/question/your/ques/newest/${userId}`,
      Auth
    );
