...
export const upVoteAction = (id, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://stack-overflow-063y.onrender.com/api/question/upVote/${id}`,
      { user: userId },
      config
    );
...
export const UnUpVoteAction = (id, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://stack-overflow-063y.onrender.com/api/question/UnUpVote/${id}`,
      { user: userId },
      config
    );
...
export const UnDownVoteAction = (id, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://stack-overflow-063y.onrender.com/api/question/UnDownVote/${id}`,
      { user: userId },
      config
    );
...
export const downVoteAction = (id, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://stack-overflow-063y.onrender.com/api/question/downVote/${id}`,
      { user: userId },
      config
    );
...
export const upVoteAnsAction =
  (postId, answerId, userId) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(
        `https://stack-overflow-063y.onrender.com/api/question/ansVote/up/${postId}`,
...
export const downVoteAnsAction =
  (postId, answerId, userId) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(
        `https://stack-overflow-063y.onrender.com/api/question/ansVote/down/${postId}`,
        { answerId: answerId, user: userId },
        config
      );
...
export const UnUpVoteAnsAction = (postId, answerId, userId) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(
        `https://stack-overflow-063y.onrender.com/api/question/ansUnVote/up/${postId}`,
        { answerId: answerId, user: userId },
        config
      );
  ...
  export const UnDownVoteAnsAction = (postId, answerId, userId) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(
        `https://stack-overflow-063y.onrender.com/api/question/ansUnVote/down/${postId}`,
        { answerId: answerId, user: userId },
        config
      );
