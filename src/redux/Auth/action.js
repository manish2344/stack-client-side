...
export const registerAction = (credentials) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(`https://stack-overflow-063y.onrender.com/api/user/create`, credentials);
    if (res.data.error)
...
export const loginAction = (credentials) => async (dispatch) => {
 try {
   ...
   const res = await axios.post(`https://stack-overflow-063y.onrender.com/api/user/login`, credentials)
