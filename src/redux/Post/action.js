...
export const newestAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/newest`);
...
export const featuredAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/featured`);
...
export const interestingAction = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/inter`);
