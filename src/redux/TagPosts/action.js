...
export const tagPostNewestAction = (tag) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/tags/${tag}`);
...
export const tagPostFeaturedAction = (tag) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/tags/f/${tag}`);
...
export const tagPostInterestingAction = (tag) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://stack-overflow-063y.onrender.com/api/question/tags/i/${tag}`);
